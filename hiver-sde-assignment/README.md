...
1. A runnable repository and pipeline.
2. A manually labelled golden evaluation set.
3. An automated evaluation harness.
4. Baseline comparisons.
5. Human/LLM-based response-quality evaluation.
6. Failure analysis with real examples.
7. Analysis of what can be misleading about the headline metric.
8. A decision log explaining important engineering decisions.
9. A discussion of what would be improved with additional development time.
...
TF-IDF Vectorization
        ...
        |                          |
        v                          v
Intent Classification       Historical Search
        |                          |
        |                          v
...
# 38. What I Would Do With One More Week

With one additional week, I would focus on the following improvements.

## 1. Semantic Embeddings

Replace or supplement TF-IDF with sentence embeddings.

This would improve retrieval for messages with different wording but similar meanings.

## 2. Better Response Generation

Use an LLM-based response generator grounded in retrieved historical information.

The model would be instructed not to invent unsupported information.

## 3. Better Confidence Calibration

Calibrate prediction confidence and evaluate whether high-confidence predictions are actually more reliable.

## 4. Larger Golden Set

Expand the golden evaluation set with more difficult and ambiguous customer-support examples.

## 5. Stronger Human Evaluation

Collect structured human ratings for response relevance, helpfulness, accuracy, clarity and safety.

## 6. Compare LLM Judge with Humans

Measure how closely the automated evaluator agrees with human evaluators.

## 7. Conversation Context

Use previous customer messages when available.

This would help resolve ambiguous messages such as:

    It still hasn't arrived.

## 8. Better Escalation

Build a more sophisticated escalation policy based on uncertainty, intent type and missing information.
